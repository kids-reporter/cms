    ...
    <>
      {
        <div className="entry-content">
          ...
          >
            <div className="stk-row stk-inner-blocks stk-block-content stk-content-align stk-0dc58f0-column stk--fit-content alignfull">
              <div
                className="wp-block-stackable-column stk-block-column stk-block-column--v2 stk-column stk-block stk-e1ad890"
                data-block-id="e1ad890"
              >
                <div className="stk-column-wrapper stk-block-column__content stk-container stk-e1ad890-container stk--no-background stk--no-padding">
                  <div className="stk-block-content stk-inner-blocks stk-e1ad890-inner-blocks">
                    <div className="footer-top">
                      <div className="footer-top__left">
                        ...
                        <div className="footer-top__left-social">
                          <div className="footer-top__social-icon-group">
                            ...
                            <a
                              href="https://github.com/twreporter"
                              className="footer-top__social-icon-item"
                              target="_blank"
                            >
                              <svg
                            ...
                            <a
                              href="https://kids.twreporter.org/feed/"
                              className="footer-top__social-icon-item"
                              target="_blank"
                            >
                              <svg
                      ...
                      <div className="footer-top__middle">
                        <div className="footer-top__team-box">
                          <a
                            href="/about"
                            className="footer-top__team-box-item"
                          >
                            <img
                        ...
                        <div className="footer-top__left-social-m">
                          <div className="footer-top__social-icon-group">
                            <a
                              href="https://www.facebook.com/twreporter/"
                              className="footer-top__social-icon-item"

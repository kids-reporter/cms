...
/*
const teamInfo = [
  {id: '', desc: '總監工作就是「總兼」，把大家的企畫統合，同時我也是一名記者。我和團隊努力把重要的新聞和事件，轉成豐富的報導，讓大家透過報導，更認識這個世界和自己。',},
  {id: '', desc: '主編就是協助稿件從企劃到編輯完成的主要橋樑。我也負責Podcast聲音平台及教案規劃，和團隊用多元的呈現方式，把重要議題轉成孩子有興趣閱讀、老師家長容易教學應用的素材。',},
  {id: '', desc: '記者的工作是將每位人物的故事、事件歷程，透過每一次的訪問紀錄下來，並將重點寫成大家能夠讀懂的文章，讓讀者看到來自各領域的不同面貌，獲取更多的資訊。',},
  {id: '', desc: '我在左腦擅長理性邏輯的學習中，用圖像刺激右腦感性創意的思考，依報導內容開發出兼具資訊事實、引人入勝的圖像，讓報導有趣，豐富閱讀多重體驗。',},
  {id: '', desc: '在這裡，大家所看見的圖表、插畫、圖文故事，大大小小的視覺元素，都是由設計師或插畫家完成。希望透過圖像的力量，幫助讀者理解事件、開啟對世界的想像！',},
  {id: '', desc: '在新聞的世界裡，「設計」這個角色就是要發力讓報導變得更好看、更好懂，所以我們把重要的故事情境化成畫作，把複雜的資料轉成圖表，努力吸引你們的眼球！',},
  {id: '', desc: '身為編輯，我是每篇報導的第一個讀者，要核對內容屬實無誤，也要給文章一個吸睛又能傳達重點的標題，同時我也要運用各種管道，讓更多讀者看見我們的文章，並且感同身受。',},
]
*/
